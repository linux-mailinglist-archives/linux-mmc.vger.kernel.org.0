Return-Path: <linux-mmc+bounces-3606-lists+linux-mmc=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-mmc@lfdr.de
Delivered-To: lists+linux-mmc@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 63899964120
	for <lists+linux-mmc@lfdr.de>; Thu, 29 Aug 2024 12:17:42 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 1412D2888C2
	for <lists+linux-mmc@lfdr.de>; Thu, 29 Aug 2024 10:17:41 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 28E7C1537CB;
	Thu, 29 Aug 2024 10:16:21 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="dTmlrqBb"
X-Original-To: linux-mmc@vger.kernel.org
Received: from mail-pf1-f181.google.com (mail-pf1-f181.google.com [209.85.210.181])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id F3BA218E74E;
	Thu, 29 Aug 2024 10:16:17 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.210.181
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1724926580; cv=none; b=ZjvzxP+X8m+X7HO0ciRT7PJJiHzCfk1apD9hY9883Qw5s/3peSdIhRBFLzxOXCbEgMxvjDTwedoevEWCRreBVLPoXB7SBc/CBzfYyfW8TusUln9xK1Tnhi1v96fzvFGpnKa9ApZzN90rpFvZHv4IqeABAoFMSCA2dltCcOCmq38=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1724926580; c=relaxed/simple;
	bh=UWmT3mVn7MmaRXj9cwtm6wSPbxAZrSPLFnSTnIeN+Q8=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=DFMk/tM45BPShYzw6xxOTve3WIVB6upD21BzS5f4C7NGX5Wnoo/erRblHIOVz3hDUw4roFb6LtIPAbmghXoEW0wdlC8hlyMjtakdw89U/tf6vn7U0D9O3ZNoJY7rMwjVSoi/Fz56ZU8Wu42J8mE9xeTxZ5BWdtJ4AyoUquo7WNE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=dTmlrqBb; arc=none smtp.client-ip=209.85.210.181
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-pf1-f181.google.com with SMTP id d2e1a72fcca58-7141d7b270dso410172b3a.2;
        Thu, 29 Aug 2024 03:16:17 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1724926577; x=1725531377; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=+g7IdjTS/zdXhm+CKw3PK4B6a2exEVU05AYA0GWclcE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1724926577; x=1725531377;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=+g7IdjTS/zdXhm+CKw3PK4B6a2exEVU05AYA0GWclcE=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCVVsG/B7ryKWHilaA2Dc3nbDgvW7wneZfxwzu0ON+41ybL4AM7LZR8sgJD6sKk3zWANBsHoQgfIo215w0E=@vger.kernel.org
X-Gm-Message-State: AOJu0YwGauy0fUS6W9Bg6K+g/WD/Ix+b/VApFonLpOB3GCQi9a4kfjqS
	OrjWTljXJNfeXBbiOj9EzCcWMIUiQKDzVmtELQgqT8WcVTzDREXG
X-Google-Smtp-Source: AGHT+IF+ObJ/gs4r526jWWpWVZA+TEhKfUYghBDs8W+9C7MG1Jaavl60eiZrr7HxhczU1GP/3T6BnQ==
X-Received: by 2002:a05:6a20:e617:b0:1ca:ccd1:4b33 with SMTP id adf61e73a8af0-1cce0fed420mr2538243637.7.1724926576918;
        Thu, 29 Aug 2024 03:16:16 -0700 (PDT)
Received: from localhost.localdomain ([2402:7500:479:a52:632f:b914:4ddf:273])
        by smtp.gmail.com with ESMTPSA id d2e1a72fcca58-715e56d77eesm816577b3a.153.2024.08.29.03.16.11
...
Subject: [PATCH V19 07/22] mmc: core: Support UHS-II card control and access
Date: Thu, 29 Aug 2024 18:15:24 +0800
Message-Id: <20240829101539.5058-8-victorshihgli@gmail.com>
...
index ee37ad14e79e..0b055b83a222 100644
--- a/drivers/mmc/core/sd.c
+++ b/drivers/mmc/core/sd.c
@@ -208,7 +208,7 @@ static int mmc_decode_csd(struct mmc_card *card)
 /*
...
@@ -905,7 +905,7 @@ int mmc_sd_get_csd(struct mmc_card *card)
 	return 0;
 }
...
@@ -1634,7 +1634,7 @@ static void mmc_sd_detect(struct mmc_host *host)
 	}
 }
...
@@ -1662,7 +1662,7 @@ static int sd_busy_poweroff_notify_cb(void *cb_data, bool *busy)
 	return 0;
 }
...
+int sd_poweroff_notify(struct mmc_card *card)
 {
 	...
 	u8 *reg_buf;
@@ -1710,7 +1710,7 @@ static int _mmc_sd_suspend(struct mmc_host *host)
...
index 8b9b34286ef3..dd76a2093a05 100644
...
index f0ac2e469b32..291f89e12c65 100644
...
+	struct uhs2_command	*uhs2_cmd;	/* UHS2 command */
 ...
 struct mmc_data {
@@ -154,6 +170,7 @@ struct mmc_request {
...
index 039008af9901..c2d80e0468f6 100644
...
@@ -713,6 +722,12 @@ static inline void mmc_debugfs_err_stats_inc(struct mmc_host *host,
