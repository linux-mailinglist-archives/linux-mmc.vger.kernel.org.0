...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0EBE241CA46
	for <lists+linux-mmc@lfdr.de>; Wed, 29 Sep 2021 18:37:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1345942AbhI2Qi4 (ORCPT <rfc822;lists+linux-mmc@lfdr.de>);
        Wed, 29 Sep 2021 12:38:56 -0400
Received: from mail.kernel.org ([198.145.29.99]:39662 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1345950AbhI2Qiw (ORCPT <rfc822;linux-mmc@vger.kernel.org>);
        Wed, 29 Sep 2021 12:38:52 -0400
Received: by mail.kernel.org (Postfix) with ESMTPSA id EFF2A6142A;
        Wed, 29 Sep 2021 16:37:10 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1632933431;
        bh=Ca+u/bXYaB9Y/R3rYNAwc4iXaQylRtuQ243JWEyKfUM=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [PATCH v4 3/4] blk-crypto: rename blk_keyslot_manager to blk_crypto_profile
Date:   Wed, 29 Sep 2021 09:35:59 -0700
Message-Id: <20210929163600.52141-4-ebiggers@kernel.org>
...
index 1fa4d5582dca5..8b0f27a745d98 100644
...
index 029c9631ec2bf..14b6a29fbf77a 100644
--- a/drivers/scsi/ufs/ufshcd.c
+++ b/drivers/scsi/ufs/ufshcd.c
@@ -4987,7 +4987,7 @@ static int ufshcd_slave_configure(struct scsi_device *sdev)
...
index 5ac62da7783aa..a2bee01ebe15a 100644
...
index bd4086a6f28e0..6d543303f890d 100644
...
index 0e960d74615ec..03db39411ef98 100644
--- a/include/linux/blkdev.h
+++ b/include/linux/blkdev.h
@@ -29,7 +29,7 @@ struct pr_ops;
 struct rq_qos;
...
@@ -223,8 +223,7 @@ struct request_queue {
