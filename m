Return-Path: <linux-mmc+bounces-3535-lists+linux-mmc=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-mmc@lfdr.de
Delivered-To: lists+linux-mmc@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 41C1C96035F
	for <lists+linux-mmc@lfdr.de>; Tue, 27 Aug 2024 09:40:00 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 05D6A1F22B88
	for <lists+linux-mmc@lfdr.de>; Tue, 27 Aug 2024 07:39:58 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0E667156886;
	Tue, 27 Aug 2024 07:39:47 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=rock-chips.com header.i=@rock-chips.com header.b="RWdtJCgJ"
X-Original-To: linux-mmc@vger.kernel.org
Received: from mail-m1031.netease.com (mail-m1031.netease.com [154.81.10.31])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 84D5E1386C6;
	Tue, 27 Aug 2024 07:39:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=154.81.10.31
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1724744386; cv=none; b=u5cKRvahERwNe5HQOcBNTp9YMarMtS+tSyy1Fvx4inIYwZzmbMeUDFuVBF76MQUbbKuZuKSh56CsZRUcm+zU0x3wpOa3pJVpZNUqTuNTuTTkBaBEa2YgFWCEuvyXnNgW1MLTYqEcE/tHoPcrTIsJ+pehgczFZsJ183iG5SLm8pE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1724744386; c=relaxed/simple;
	bh=GNSLpcviIGuJCaoJUsVwf3vnobZC8yTPSTV9uuZXVl4=;
	h=Message-ID:Date:MIME-Version:Subject:To:Cc:References:From:
	 In-Reply-To:Content-Type; b=IK8Vsn2PwDv0g8JwJ5ZJWeGLDjCcR0NPyMNzO4VUAS9WYSYe/ReCPs3RxfghaGyKttBnrSNShOYh72esHvmxKrbRqS8rfnca9e/96+1yr2L8sUZR7MNEppfTVz8mtOOk2o1DV7sSUaBWVku+V1M0+BsCdZOBImTLFnJdG99k+zY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=rock-chips.com; spf=pass smtp.mailfrom=rock-chips.com; dkim=pass (1024-bit key) header.d=rock-chips.com header.i=@rock-chips.com header.b=RWdtJCgJ; arc=none smtp.client-ip=154.81.10.31
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=rock-chips.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=rock-chips.com
DKIM-Signature: a=rsa-sha256;
	b=RWdtJCgJFCSqB9hWvLY3z61YVo/uBYn86v6MsiBIwuHxat6fAFk/2Pcd7fmpmrT7jIPTOfLPAiU2Q8J3cgn3JwMk3gnt0WWrzGmLHj2QqFkLFWEod7LtwLapKhqyhQfuOAX47X+KRecq1jDxBUCgJzxVeVVUbtrQ//YsAsW3aT0=; c=relaxed/relaxed; s=default; d=rock-chips.com; v=1;
	bh=ELNjvT+GkI+npKhjOiaCaXJbaMtj6iVeb2JQaUUZSoU=;
	h=date:mime-version:subject:message-id:from;
Received: from [172.16.12.30] (unknown [58.22.7.114])
	by smtp.qiye.163.com (Hmail) with ESMTPA id 11A00A012E;
	Tue, 27 Aug 2024 09:02:16 +0800 (CST)
Message-ID: <7495066c-a75d-4688-97d0-e033c0ebad5c@rock-chips.com>
Date: Tue, 27 Aug 2024 09:02:15 +0800
Precedence: bulk
...
Cc: Rob Herring <robh@kernel.org>, Krzysztof Kozlowski <krzk+dt@kernel.org>,
 ...
 <linux@roeck-us.net>, Chris Morgan <macromorgan@hotmail.com>,
 ...
 Elon Zhang <zhangzj@rock-chips.com>, Yifeng Zhao
 <yifeng.zhao@rock-chips.com>, Finley Xiao <finley.xiao@rock-chips.com>,
...
References: <20240823150057.56141-1-detlev.casanova@collabora.com>
 ...
 <3309312.aeNJFYEL58@bootstrap>
From: zhangqing <zhangqing@rock-chips.com>
In-Reply-To: <3309312.aeNJFYEL58@bootstrap>
Content-Type: text/plain; charset=UTF-8; format=flowed
Content-Transfer-Encoding: 8bit
X-HM-Spam-Status: e1kfGhgUHx5ZQUpXWQgPGg8OCBgUHx5ZQUlOS1dZFg8aDwILHllBWSg2Ly
	tZV1koWUFDSUNOT01LS0k3V1ktWUFJV1kPCRoVCBIfWUFZQhlDQlZKHUpCGUlLSRhJThpWFRQJFh
	oXVRMBExYaEhckFA4PWVdZGBILWUFZTkNVSUlVTFVKSk9ZV1kWGg8SFR0UWUFZT0tIVUpLSUhCSE
	NVSktLVUpCS0tZBg++
X-HM-Tid: 0a91915ae4f203a8kunm11a00a012e
X-HM-MType: 1
X-HM-Sender-Digest: e1kMHhlZQR0aFwgeV1kSHx4VD1lBWUc6Ogg6Czo6DDI3EhwwA0g6ShAM
	EA4KFCpVSlVKTElPTElLTkhCQkNJVTMWGhIXVQETGhUcChIVHDsJFBgQVhgTEgsIVRgUFkVZV1kS
	C1lBWU5DVUlJVUxVSkpPWVdZCAFZQUlKQ0tOSzcG

Hi

在 2024/8/27 1:54, Detlev Casanova 写道:
> Hi Elaine,
>
> Thank you for the fixes ! Can you confirm that the USB PD must be a child of the
> VOP PD node ?

The NOC bus of USB passes through the PD of VOP, so it relies on VOP PD.

Other dependencies are similarly treated as parent-child properties.

Dependencies are described in a separate document and may require a 
special request to obtain.
...
>>
>> 在 2024/8/24 0:11, Detlev Casanova 写道:
...
>>> +		interrupt-affinity = <&cpu_b0>, <&cpu_b1>, <&cpu_b2>,
> <&cpu_b3>;
>>> +	};
>>> +
>>> +	psci {
...
>>> +			compatible = "rockchip,rk3576-bigcore-grf",
> "syscon";
>>> +			reg = <0x0 0x2600c000 0x0 0x2000>;
>>> +		};
>>> +
>>> +		litcore_grf: syscon@2600e000 {
>>> +			compatible = "rockchip,rk3576-litcore-grf",
> "syscon";
...
>>> +			compatible = "rockchip,rk3576-pmu0-grf", "syscon",
> "simple-mfd";
...
>>> +			compatible = "rockchip,rk3576-pipe-phy-grf",
> "syscon";
...
>>> +			compatible = "rockchip,rk3576-usbdpphy-grf",
> "syscon";
>>> +			reg = <0x0 0x2602c000 0x0 0x2000>;
>>> +		};
>>> +
>>> +		sdgmac_grf: syscon@26038000 {
>>> +			compatible = "rockchip,rk3576-sdgmac-grf",
> "syscon";
>>> +			reg = <0x0 0x26038000 0x0 0x1000>;
>>> +		};
>>> +
>>> +		ioc_grf: syscon@26040000 {
>>> +			compatible = "rockchip,rk3576-ioc-grf", "syscon",
> "simple-mfd";
...
>>> +				<&cru CLK_UART_FRAC_1>, <&cru
> CLK_UART_FRAC_2>,
>>> +				<&cru CLK_AUDIO_FRAC_0>, <&cru
> CLK_AUDIO_FRAC_1>,
>>> +				<&cru CLK_CPLL_DIV2>, <&cru
> CLK_CPLL_DIV4>,
>>> +				<&cru CLK_CPLL_DIV10>, <&cru
> FCLK_DDR_CM0_CORE>,
>>> +				<&cru ACLK_PHP_ROOT>;
...
>>> +			compatible = "rockchip,rk3576-pmu", "syscon",
> "simple-mfd";
>>> +			reg = <0x0 0x27380000 0x0 0x800>;
>>> +
>>> +			power: power-controller {
>>> +				compatible = "rockchip,rk3576-power-
> controller";
...
>>> +
>>> +		gpu: gpu@27800000 {
>>> +			compatible = "rockchip,rk3576-mali", "arm,mali-
> bifrost";
...
>>> +			clocks = <&cru CLK_GMAC0_125M_SRC>, <&cru
> CLK_GMAC0_RMII_CRU>,
...
>>> +			clocks = <&cru CLK_GMAC1_125M_SRC>, <&cru
> CLK_GMAC1_RMII_CRU>,
...
> &sdmmc0_bus4
>>> &sdmmc0_pwren>; +			power-domains = <&power
> RK3576_PD_SDGMAC>;
...
>>> +			assigned-clocks = <&cru BCLK_EMMC>, <&cru
> TCLK_EMMC>, <&cru
>>> CCLK_SRC_EMMC>; +			assigned-clock-rates =
> <200000000>, <24000000>,
>>> <200000000>;
>>> +			clocks = <&cru CCLK_SRC_EMMC>, <&cru HCLK_EMMC>,
>>> +				 <&cru ACLK_EMMC>, <&cru BCLK_EMMC>,
>>> +				 <&cru TCLK_EMMC>;
>>> +			clock-names = "core", "bus", "axi", "block",
> "timer";
>>> +			interrupts = <GIC_SPI 253 IRQ_TYPE_LEVEL_HIGH>;
>>> +			max-frequency = <200000000>;
>>> +			pinctrl-0 = <&emmc_rstnout>, <&emmc_bus8>,
> <&emmc_clk>,
>>> +				    <&emmc_cmd>, <&emmc_strb>;
>>> +			pinctrl-names = "default";
...
>>> +				 <&cru SRST_T_EMMC>;
>>> +			reset-names = "core", "bus", "axi", "block",
> "timer";
>>> +			supports-cqe;
>>> +			status = "disabled";
>>> +		};
...
>>> +			compatible = "rockchip,rk3576-timer",
...
>>> +
>>> +		spi0: spi@2acf0000 {
>>> +			compatible = "rockchip,rk3576-spi",
> "rockchip,rk3066-spi";
...
>>> +			num-cs = <2>;
>>> +			pinctrl-names = "default";
>>> +			pinctrl-0 = <&spi0m0_csn0 &spi0m0_csn1
> &spi0m0_pins>;
>>> +			#address-cells = <1>;
>>> +			#size-cells = <0>;
>>> +			status = "disabled";
...
>>> +			num-cs = <2>;
>>> +			pinctrl-names = "default";
>>> +			pinctrl-0 = <&spi1m0_csn0 &spi1m0_csn1
> &spi1m0_pins>;
>>> +			#address-cells = <1>;
>>> +			#size-cells = <0>;
>>> +			status = "disabled";
...
>>> +			num-cs = <2>;
>>> +			pinctrl-names = "default";
>>> +			pinctrl-0 = <&spi2m0_csn0 &spi2m0_csn1
> &spi2m0_pins>;
>>> +			#address-cells = <1>;
>>> +			#size-cells = <0>;
>>> +			status = "disabled";
...
>>> +			num-cs = <2>;
>>> +			pinctrl-names = "default";
>>> +			pinctrl-0 = <&spi3m0_csn0 &spi3m0_csn1
> &spi3m0_pins>;
>>> +			#address-cells = <1>;
>>> +			#size-cells = <0>;
>>> +			status = "disabled";
...
>>> +			num-cs = <2>;
>>> +			pinctrl-names = "default";
>>> +			pinctrl-0 = <&spi4m0_csn0 &spi4m0_csn1
> &spi4m0_pins>;
>>> +			#address-cells = <1>;
>>> +			#size-cells = <0>;
>>> +			status = "disabled";
...
>>> +
>>> +		saradc: adc@2ae00000 {
>>> +			compatible = "rockchip,rk3576-saradc",
...
>>> +				clocks = <&cru PCLK_GPIO3>, <&cru
> DBCLK_GPIO3>;
>>> +				gpio-controller;
>>> +				gpio-ranges = <&pinctrl 0 96 32>;
>>> +				interrupts = <GIC_SPI 165
> IRQ_TYPE_LEVEL_HIGH>;
>>> +				interrupt-controller;
>>> +				#gpio-cells = <2>;
>>> +				#interrupt-cells = <2>;
