...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1AF0D42AF32
	for <lists+linux-mmc@lfdr.de>; Tue, 12 Oct 2021 23:45:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235747AbhJLVrc (ORCPT <rfc822;lists+linux-mmc@lfdr.de>);
        Tue, 12 Oct 2021 17:47:32 -0400
Received: from mail.kernel.org ([198.145.29.99]:37568 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S235702AbhJLVr3 (ORCPT <rfc822;linux-mmc@vger.kernel.org>);
        Tue, 12 Oct 2021 17:47:29 -0400
Received: by mail.kernel.org (Postfix) with ESMTPSA id 8634E6101D;
        Tue, 12 Oct 2021 21:45:26 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1634075126;
        bh=X7RoeaYqAXEChgvUfrFOq4J3PtkKK4Wkq+7O79xODcA=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [PATCH v5 3/4] blk-crypto: rename blk_keyslot_manager to blk_crypto_profile
Date:   Tue, 12 Oct 2021 14:43:29 -0700
Message-Id: <20211012214330.40470-4-ebiggers@kernel.org>
...
index a8cd064f6d643..db228e45820e5 100644
--- a/drivers/md/dm.c
+++ b/drivers/md/dm.c
@@ -1660,14 +1660,14 @@ static const struct dax_operations dm_dax_ops;
...
@@ -1693,7 +1693,7 @@ static void cleanup_mapped_device(struct mapped_device *md)
 			dm_sysfs_exit(md);
 			del_gendisk(md->disk);
 		}
...
index a9c1d08825503..0ea96f6a0b0f8 100644
...
index 2a8689e949b4c..6c4a446ee5ea2 100644
...
@@ -1160,19 +1159,20 @@ int kblockd_mod_delayed_work_on(int cpu, struct delayed_work *dwork, unsigned lo
